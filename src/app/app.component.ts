...
export class AppComponent implements OnInit {
  ...
  setSEO(): void {
    ...
    this.metaService.addTags([
      ...
      { property: 'og:image', content: 'https://ufabankruptcy.ru/assets/images/preview-image.webp' }, // Путь к изображению для соцсетей
    ...
    this.metaService.addTags([
      ...
      { name: 'twitter:image', content: 'https://ufabankruptcy.ru/assets/images/preview-image.webp' }, // Укажи путь к изображению
